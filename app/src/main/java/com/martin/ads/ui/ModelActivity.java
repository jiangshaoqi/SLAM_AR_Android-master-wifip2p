...
public class ModelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkPermission(Manifest.permission.CAMERA,REQUEST_PERMISSION) &&
                checkPermission(Manifest.permission.CHANGE_NETWORK_STATE, REQUEST_PERMISSION) &&
                checkPermission(Manifest.permission.ACCESS_NETWORK_STATE, REQUEST_PERMISSION) &&
                checkPermission(Manifest.permission.ACCESS_WIFI_STATE, REQUEST_PERMISSION) &&
                checkPermission(Manifest.permission.CHANGE_WIFI_STATE, REQUEST_PERMISSION) &&
                checkPermission(Manifest.permission.ACCESS_FINE_LOCATION, REQUEST_PERMISSION))
            init();
    }
