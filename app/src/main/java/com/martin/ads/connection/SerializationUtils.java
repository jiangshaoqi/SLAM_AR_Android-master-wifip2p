...
public class SerializationUtils {
     ...
     *  net.semanticmetadata.lire.utils.SerializationUtils#toBytes(int)
     */
     ...
     *  net.semanticmetadata.lire.utils.SerializationUtils#toInt(byte[])
     */
     ...
     * net.semanticmetadata.lire.utils.SerializationUtils#toFloat(byte[])} to decode.
     *
     * @param data the float to convert
     * @return the resulting byte array
     * net.semanticmetadata.lire.utils.SerializationUtils#toFloat(byte[])
     */
     ...
     * and fast way by shifting without using streams (which is kind of slow). Use
     * net.semanticmetadata.lire.utils.SerializationUtils#toBytes(float)} to encode.
     *
     * @param data the input byte array
     * @return the resulting float
     *  net.semanticmetadata.lire.utils.SerializationUtils#toBytes(float)
     */
     ...
     * and fast way by shifting without using streams (which is kind of slow). Use
     * net.semanticmetadata.lire.utils.SerializationUtils#toDouble(byte[])} to decode. Note that there is a loss
     * in precision as the double is converted to a float in the course of conversion.
     *
     * @param data the double to convert
     * @return the resulting byte array
     * net.semanticmetadata.lire.utils.SerializationUtils#toDouble(byte[])
     */
     ...
     * and fast way by shifting without using streams (which is kind of slow). Use
     * net.semanticmetadata.lire.utils.SerializationUtils#toBytes(double)} to encode. Note that there is a loss
     * in precision as the double is converted to a float in the course of conversion.
     *
     * @param data the input byte array
     * @return the resulting float
     * net.semanticmetadata.lire.utils.SerializationUtils#toBytes(double)
     */
